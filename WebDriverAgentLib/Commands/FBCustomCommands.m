...
+ (NSArray *)routes
{
  ...
  @[
    ...
    [[FBRoute POST:@"/wda/touchAndHold"] respondWithTarget:self action:@selector(handleDeviceTap:)],
    ...
    [[FBRoute POST:@"/wda/dragfromtoforduration"] respondWithTarget:self action:@selector(handleDeviceSwipe:)],
...
{
  CGFloat x1 = [request.arguments[@"fromX"] doubleValue];
  CGFloat y1 = [request.arguments[@"fromY"] doubleValue];
  CGFloat x2 = [request.arguments[@"toX"] doubleValue];
  CGFloat y2 = [request.arguments[@"toY"] doubleValue];
